= Couchbase Operational Insights .NET SDK Documentation

This repository hosts the documentation source for the
https://docs.couchbase.com/operational-insights-dotnet-sdk/1.0/hello-world/overview.html[Operational Insights .NET SDK Documentation].


This branch documents the 1.0 release of the SDK.
It follows the https://docs.couchbase.com/operational-insights-dotnet-sdk/1.0/project-docs/compatibility.html#api-version[Operational Insights SDK 1.0 API].
...
https://github.com/couchbase/docs-operational-insights-sdk-common[docs-operational-insights-sdk-common],
...
The philosophy behind the Information Architecture can be found in the https://docs.couchbase.com/scala-sdk/3.13/project-docs/metadoc-about-these-sdk-docs.html[meta doc].
////
...
* concept-docs -- discussion docs explaining SDK-relevant aspects of Couchbase & Analytics (Insights); in the published docs these are now interleaved with the howtos, rather than in a separate section.
...
Most re-use is from single-sourced content in the https://github.com/couchbase/docs-operational-insights-sdk-common[sdk-common] repo.

=== Single-sourced Content

To make maintenance easier for docs of many SDKs, content that is common across SDK docsets is -- wherever possible -- single-sourced from the https://github.com/couchbase/docs-operational-insights-sdk-common[sdk-operational-insights-common] repo.
...
This is the release version of Operational Insights that this SDK release accompanied.
...
| `name-sdk:` | Allows us to name the SDK within shared content (*.NET Operational Insights SDK*).
